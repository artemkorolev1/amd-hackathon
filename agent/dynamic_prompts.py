...
_CATEGORY_PROMPTS: dict[str, dict[str, str]] = {
    ...
    "code_gen": {
        "low": (
            "Code: Write clean, working Python code. No preamble. "
    ...
    # ═══════════════════════════════════════════════════════════════════════
    # CODING CHALLENGE — data structure (tree/graph/linked list)
    # ═══════════════════════════════════════════════════════════════════════
    "coding_challenge_ds": {
        "low": (
            "Solve the coding problem involving a tree or graph data structure. "
            "Output ONLY the complete Python solution inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Consider DFS, BFS, recursion, or iterative traversal approaches. "
            "No explanation outside the code block."
        ),
        "medium": (
            "Solve the tree/graph problem. Output ONLY the function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Handle edge cases (empty tree, single node, disconnected components, cycles). "
            "Add a one-line docstring. No explanation outside the code block."
        ),
        "high": (
            "Solve the tree/graph problem. Output ONLY the function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Handle all edge cases. Consider time/space complexity. "
            "If the problem mentions constraints, optimize accordingly. "
            "Include a brief docstring. No explanation outside the code block."
        ),
    },
    # ═══════════════════════════════════════════════════════════════════════
    # CODING CHALLENGE — dynamic programming
    # ═══════════════════════════════════════════════════════════════════════
    "coding_challenge_dp": {
        "low": (
            "Solve the dynamic programming problem. "
            "Output ONLY the complete Python function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Define states clearly, establish recurrence relations, handle base cases. "
            "No explanation outside the code block."
        ),
        "medium": (
            "Solve the DP problem. Output ONLY the function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Define the DP table/states, recurrence relation, and base cases explicitly. "
        ...
        "high": (
            "Solve the DP problem. Output ONLY the function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Define the DP formulation clearly. Optimize for the given constraints. "
            "Consider both memoization (top-down) and tabulation (bottom-up) approaches. "
            "Handle all edge cases. No explanation outside the code block."
        ),
    },
    # ═══════════════════════════════════════════════════════════════════════
    # CODING CHALLENGE — sorting / searching / math
    # ═══════════════════════════════════════════════════════════════════════
    "coding_challenge_sort_search": {
        "low": (
            "Solve the sorting, searching, or math problem. "
            "Output ONLY the complete Python function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Consider binary search, two-pointer, heap, or math-based approaches. "
            "No explanation outside the code block."
        ),
        "medium": (
            "Solve the sort/search/math problem. Output ONLY the function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Consider the most efficient algorithm for the given constraints. "
            "Handle edge cases (empty input, duplicates, overflow, bounds). "
            "No explanation outside the code block."
        ),
        "high": (
            "Solve the sort/search/math problem. Output ONLY the function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Optimize time/space complexity for the given constraints. "
            "Handle all edge cases including large inputs, negative values, overflow. "
            "No explanation outside the code block."
        ),
    },
    # ═══════════════════════════════════════════════════════════════════════
    # CODING CHALLENGE — generic formal (structured I/O, no special category)
    # ═══════════════════════════════════════════════════════════════════════
    "coding_challenge_formal": {
        "low": (
            "Solve the coding problem. Output ONLY the complete Python function "
            "inside ```python ... ```. Preserve the exact function name and signature. "
            "Follow the input/output format from the problem description exactly. "
            "No explanation outside the code block."
        ),
        "medium": (
            "Solve the coding problem. Output ONLY the function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Handle edge cases mentioned in the constraints. "
            "Follow the exact I/O format from examples. "
            "No explanation outside the code block."
        ),
        "high": (
            "Solve the coding problem. Output ONLY the function inside ```python ... ```. "
            "Preserve the exact function name and signature. "
            "Optimize for the given constraints. Handle all edge cases. "
            "Follow the exact I/O format from examples. "
            "No explanation outside the code block."
        ),
    },
    ...
    "math": {
        "low": (
            "Solve the math problem. Output only the answer. Show your work briefly. "
            "You MUST end with 'Answer: <value>' on its own final line or the answer will be counted WRONG. "
        ...
        "medium": (
            ...
            "You MUST end with 'Answer: <value>' on its own final line or the answer will be counted WRONG. "
            "Show brief working (at most 2-3 sentences). "
        ...
        "high": (
            ...
            "You MUST end with 'Answer: <value>' on its own final line or the answer will be counted WRONG. "
            "Show reasoning clearly but concisely (at most 3-4 sentences). "
    ...
    "sentiment": {
        ...
        "medium": (
            ...
            "Watch for sarcasm, dismissiveness, and hedging — these are NEGATIVE or NEUTRAL, not positive. "
            "If the text expresses ANY negative emotion (anger, disappointment, "
            "frustration, sadness), classify as negative even if there is "
    ...
    "ner": {
        "low": (
            ...
            "Output each entity on its own line: type: entity_name. "
            "Use lowercase entity types (person, group, corporation, location, event, "
            "product, creative_work, date, time, money, percent, disease, gene, protein). "
        ...
        "medium": (
            ...
            "Use lowercase entity types (person, group, corporation, location, event, "
            "product, creative_work, date, time, money, percent, disease, gene, protein). "
            "Preserve {@...@} markers exactly as they appear. "
            "Cover every named entity — hashtags, @mentions, ALL-CAPS. "
            "Be thorough. No preamble, no commentary."
        ),
        "high": (
            "Extract ALL named entities exhaustively. "
            "Output each entity on its own line: type: entity_name. "
            "Use precise lowercase entity types (person, group, corporation, location, "
            "event, product, creative_work, date, time, money, percent, disease, gene, "
            "protein). "
            "Preserve {@...@} markers exactly. "
            "Include ALL entities: marked, unmarked, hashtags, @mentions, ALL-CAPS. "
    ...
    "summarization": {
        "low": (
            ...
            "Use exact names, numbers, and places. "
        ...
        "medium": (
            ...
            "Include exact names, numbers, and places. "
...
NER_ONE_SHOT_EXAMPLE = (
    ...
    "Text: \"I 'm yet to figure out why I should open {@WhatsApp@} mobile "
    "to get {@WhatsApp@} desktop working !\"\n"
    "Output:\n"
    "product: {@WhatsApp@}\n"
    "product: {@WhatsApp@}\n\n"
    "Text: \"Time for the main event. {@Israel Adesanya@} vs Jan #Ufc259\"\n"
    "Output:\n"
...
# ---------------------------------------------------------------------------
# Merged prompts — used when classifier is uncertain between two categories (scores close)
# ---------------------------------------------------------------------------
# These combine instructions for two categories so that classifier misclassification
...
MERGE_PROMPTS: dict[str, dict[str, str]] = {
    "reasoning": {
        ...
        # where classifier uncertainty costs real accuracy
        "low": (
...
def build_merged_prompt(
    ...
    """Build a merged prompt when classifier is uncertain between two categories.
...
MAX_TOKENS: dict[str, int] = {
    "code_gen": 250,
    "code_debug": 200,
    "coding_challenge_dp": 200,
    "coding_challenge_ds": 200,
    "coding_challenge_formal": 200,
    "coding_challenge_sort_search": 200,
    "math": 512,
    "logic": 200,
    "factual": 120,
    "sentiment": 60,
...
STOP_SEQUENCES: dict[str, list[str]] = {
    "code_gen": ["```\n\n", "\n\n```"],
    "code_debug": ["```\n\n", "\n\n```"],
    "coding_challenge_dp": ["</s>"],
    "coding_challenge_ds": ["</s>"],
    "coding_challenge_formal": ["</s>"],
    "coding_challenge_sort_search": ["</s>"],
    "math": ["\n\n", "Question:"],
    "logic": ["\n\n", "Question:"],
    "factual": ["\n\n", "Question:"],
    "sentiment": ["\n\n"],
